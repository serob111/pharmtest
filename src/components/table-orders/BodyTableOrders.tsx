      ...
      {rows.map((order, index) => {
        return (
          ...
          >
            ...
            >
                <TooltipCell
                  content={order.external_order_id}
                />
            ...
            <td className={cn(baseCellClassName)}>
              <TooltipCell content={order.prescription_detail.appoint_date} />
            </td>
            ...
            <td className={cn(baseCellClassName)}>
              <TooltipCell content={order.event_type} />
            </td>

            <td className={cn(baseCellClassName)}>
              <Badge
                status={order.medical_system_status}
              />
            </td>
          </tr>
